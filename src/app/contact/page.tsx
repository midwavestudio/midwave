            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
              <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
                ...
                <p className="text-gray-400">
                  <a href="tel:+14155551234" className="hover:text-amber-500 transition-colors">
                    (415) 555-1234
                  </a>
                </p>
              </div>
              ...
              <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
                ...
                <p className="text-gray-400">
                  <a href="mailto:hello@midwavestudio.com" className="hover:text-amber-500 transition-colors">
